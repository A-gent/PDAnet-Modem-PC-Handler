...
| SimpleAutoConnect |                    SWITCHES       |   0-1 |           1    |   If equals 1, runs a very simplified and 'stupid' version of the AutoConnect routine above. Do not enable both of these AutoConnect functions at once! |
