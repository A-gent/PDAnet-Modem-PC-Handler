...
| SimpleAutoConnect |                    SWITCHES       |   0-1 |           0     |   If equals 1, runs a very simplified and 'stupid' version of the AutoConnect routine above. Do not enable both of these AutoConnect functions at once! |
...
| SimpleAutoConnectSpeed |      CONFIG                  |   USER DEFINED          | 6000 |   This the speed of the much more simplified version of the AutoConnect routine. This does not check if the internet is connected, and instead just attempts a reconnect every X miliseconds where X is the given speed below in the CONFIG section.  |
