...
# Check whether Mobile Hotspot is enabled ONLY, do not attempt to start it
$hotspotpulse = $tetheringManager.TetheringOperationalState

write_logFile -log_file "C:\Users\thann\Documents\ChainOverflow\hotspot_state.log" -log_message $hotspotpulse
